# 📖 A'dan Z'ye Sanat Sözlüğü

Artık terimler arasında kaybolmanıza gerek yok. İşte sanat dünyasının temel yapı taşları:

---

## A - E
*   **Abstrak (Soyut):** Gerçek nesneleri değil, renkleri, formları ve çizgileri kullanarak bir anlam yaratma çabası.
*   **Barok:** 17. yüzyıl Avrupa'sında doğan, görkemli, hareketli ve dramatik ışık-gölge kullanımıyla bilinen sanat akımı.
*   **Dışavurumculuk (Ekspresyonizm):** Sanatçının iç dünyasını, duygularını ve ruh halini renkler ve şekillerle dışa vurması.
*   **Estetik:** Güzelliğin doğasını ve sanatın felsefesini inceleyen bilim dalı.

## F - K
*   **Fovizm:** Saf ve parlak renklerin, nesnenin gerçek rengine bağlı kalınmaksızın kullanıldığı akım (Vahşilik).
...
---
> [!NOTE]
> Bu sözlük sürekli büyüyecektir. Bilmediğiniz bir terim mi var? Bir Issue açın veya Pull Request ile ekleyin!
